...
static lmh_param_t g_LoraParamInit = {
    LORAWAN_ADR_ON,
    LORAWAN_DATERATE,
...
static lmh_callback_t g_LoraCallbacks = {
...
uint8_t g_NodeAppKey[16] = {0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x33, 0x33, 0x33, 0x33, 0x33};
...
void setup()
{
    ...
    // Initialize LoRaWan
    uint32_t err_code = lmh_init(&g_LoraCallbacks, g_LoraParamInit, g_OTAA);
    if (err_code != 0)
    {
